                            ...
                            <div className='queue-item' key={customer.id}>
                                ...
                                <div className='actions'>
                                    {customer.status === 'waiting' && (
                                        <button className='serve-btn' onClick={() => onUpdateStatus(customer.id, 'serving')}>Serve</button> // whenever i click a single button all other entries get the same update if the element is <button>
                                    )}
                                    {customer.status === 'serving' && (
                                        <button className='complete-btn' onClick={() => onUpdateStatus(customer.id, 'completed')}>Complete</button>
                                    )}
